            ...
            <div class="list-group-item task-item" id="task-${this.id}">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-sm btn-outline-warning status-btn" data-task-id="${this.id}" data-status="em_andamento">Modificar</button>
...
class LazerTask extends Task {
    ...
    getHtmlRepresentation() {
        const baseHtml = super.getHtmlRepresentation();
        return baseHtml.replace('list-group-item task-item', 'list-group-item task-item task-lazer');
    }
}
